...
{
  public:
    ExampleLayer( Scene* scene ) : m_Camera( 45.0f, 0.1f, 100.0f ) {
    ...
    virtual void OnUIRender() override {
        ...
        // ImGui::DragFloat("Light intensity", glm::value_ptr(light->mat->m_emission), 1, 1,
        // 100000); light->mat->m_emission.y = light->mat->m_emission.x; light->mat->m_emission.z =
        // light->mat->m_emission.x;
