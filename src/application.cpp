...
#include "../_autogen/triangle.vert.h"
#include "../_autogen/triangle.frag.h"

/******** Debug messenger functions ********/
/* 
 * Maybe move to own file/class
*/
...
VkShaderModule Application::createShaderModule(const std::vector<uint32_t>& code){
...
void Application::createGraphicsPipeline(){
    ...
    const std::vector<uint32_t> vertex_shader(std::begin(triangle_vert), std::end(triangle_vert));
    const std::vector<uint32_t> frag_shader(std::begin(triangle_frag), std::end(triangle_frag));
