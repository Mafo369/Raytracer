...
class solid_color : public texture
{
  public:
    ...
    color3 value( float u, float v ) const override { return color_value; }

    color3 value( float u, float v, int face ) const override { return color_value; }
...
class checker_texture : public texture
{
  public:
    ...
    color3 value( float u, float v, int face ) const override { return value( u, v ); }
...
{
  public:
    image_texture( const char* filename ) { m_image = loadPng( filename ); }

    ~image_texture() { delete m_image; }
...
class AlignCheck : public texture
{
  public:
    ...
    color3 value( float u, float v ) const override {
        std::cerr << "Warning: This texture has multiple faces. Selecting default one..."
                  << std::endl;
